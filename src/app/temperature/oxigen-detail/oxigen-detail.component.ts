...
@Component({
  selector: 'app-oxigen-detail',
  templateUrl: './oxigen-detail.component.html',
  styleUrls: ['./oxigen-detail.component.scss']
})
export class OxigenDetailComponent implements OnInit {
