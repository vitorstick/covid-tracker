...
@Component({
  selector: 'app-cardiac-detail',
  templateUrl: './cardiac-detail.component.html',
  styleUrls: ['./cardiac-detail.component.scss']
})
export class CardiacDetailComponent implements OnInit {
