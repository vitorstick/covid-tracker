...
@Component({
  selector: 'app-glicemic-detail',
  templateUrl: './glicemic-detail.component.html',
  styleUrls: ['./glicemic-detail.component.scss']
})
export class GlicemicDetailComponent implements OnInit {
