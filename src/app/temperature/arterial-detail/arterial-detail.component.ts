...
@Component({
  selector: 'app-arterial-detail',
  templateUrl: './arterial-detail.component.html',
  styleUrls: ['./arterial-detail.component.scss']
})
export class ArterialDetailComponent implements OnInit {
